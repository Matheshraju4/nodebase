...
export const EntitySearch = ({ onChange, placeholder = "Search", value }: EntitySearchProps) => {
...
export const EntityPagination = ({ page, onPageChange, totalPages, disabled }: EntityPaginationProps) => {
